...
export default {
  ...
  // ============================================================================
  // Yargs CLI Commands & Options
  // ============================================================================
  'Manage MCP servers': 'Manage MCP servers',
  'Manage DM pairing requests': 'Manage DM pairing requests',
  'Manage messaging channels (Telegram, Discord, etc.)':
    'Manage messaging channels (Telegram, Discord, etc.)',
  'Manage Qwen Code hooks (use /hooks in interactive mode).':
    'Manage Qwen Code hooks (use /hooks in interactive mode).',
  'Manage Qwen Code extensions.': 'Manage Qwen Code extensions.',
  'You need at least one command before continuing.':
    'You need at least one command before continuing.',
  'Add a server': 'Add a server',
  'Remove a server': 'Remove a server',
  'List all configured MCP servers': 'List all configured MCP servers',
  'Reconnect MCP server(s)': 'Reconnect MCP server(s)',
  'Name of the server': 'Name of the server',
  'Command (stdio) or URL (sse, http)': 'Command (stdio) or URL (sse, http)',
  ...
  'A comma-separated list of tools to exclude':
    'A comma-separated list of tools to exclude',
  'Name of the server to reconnect': 'Name of the server to reconnect',
  'Reconnect all configured servers': 'Reconnect all configured servers',
  'Stop the running channel service': 'Stop the running channel service',
  'Show channel service status': 'Show channel service status',
  ...
  'The path to create the extension in.':
    'The path to create the extension in.',
  'The boilerplate template to use.': 'The boilerplate template to use.',

  // ============================================================================
  // Yargs CLI Options (config.ts)
  // ============================================================================
  ...
  'Enable chat recording to disk. If false, chat history is not saved and --continue/--resume will not work.':
    'Enable chat recording to disk. If false, chat history is not saved and --continue/--resume will not work.',
  'Launch Qwen Code CLI': 'Launch Qwen Code CLI',
  ...
  'Append instructions to the main session system prompt for this run. Can be combined with --system-prompt.':
    'Append instructions to the main session system prompt for this run. Can be combined with --system-prompt.',
  'Run in sandbox?': 'Run in sandbox?',
  'Sandbox image URI.': 'Sandbox image URI.',
  ...
  'Set the approval mode: plan (plan only), default (prompt for approval), auto-edit (auto-approve edit tools), yolo (auto-approve all tools)':
    'Set the approval mode: plan (plan only), default (prompt for approval), auto-edit (auto-approve edit tools), yolo (auto-approve all tools)',
  'Enables checkpointing of file edits': 'Enables checkpointing of file edits',
  'Starts the agent in ACP mode': 'Starts the agent in ACP mode',
  ...
  'OpenAI base URL (for custom endpoints)':
    'OpenAI base URL (for custom endpoints)',
  'Tavily API key for web search': 'Tavily API key for web search',
  ...
  'The format consumed from standard input.':
    'The format consumed from standard input.',
  'The format of the CLI output.': 'The format of the CLI output.',
  ...
  'Resume a specific session by its ID. Use without an ID to show session picker.':
    'Resume a specific session by its ID. Use without an ID to show session picker.',
  'Specify a session ID for this run.': 'Specify a session ID for this run.',
  'Maximum number of session turns': 'Maximum number of session turns',
  'Core tool paths': 'Core tool paths',
  'Tools to exclude': 'Tools to exclude',
  'Tools to allow, will bypass confirmation':
    'Tools to allow, will bypass confirmation',
  'Authentication type': 'Authentication type',

  // ============================================================================
  // Tool Display Descriptions
  // ============================================================================
  'tool_desc:read_file':
    'Reads and returns the content of a specified file. Supports text, images, and PDF files.',
  'tool_desc:write_file':
    'Writes content to a specified file in the local filesystem.',
  'tool_desc:edit':
    'Replaces text within a file. Replaces a single occurrence of the old_string with new_string.',
  'tool_desc:run_shell_command':
    'Executes a given shell command in a persistent shell session with optional timeout.',
  'tool_desc:grep_search':
    'Searches for a regular expression pattern within the content of files or directories.',
  'tool_desc:ripgrep_search':
    'Searches for a regular expression pattern within the content of files using ripgrep.',
  'tool_desc:glob':
    'Finds files matching specific glob patterns efficiently.',
  ...
  'tool_desc:todo_write':
    'Creates or updates a structured task list for the current coding session.',
  'tool_desc:web_fetch':
    "Reads a webpage's full content as clean markdown.",
  'tool_desc:web_search':
    'Searches the web for any topic and gets clean, ready-to-use content.',
  'tool_desc:agent':
  ...
  'tool_desc:lsp':
    'Language Server Protocol tool for code intelligence features.',
  'tool_desc:cron_create':
    'Creates a new cron job for scheduled task execution.',
  'tool_desc:cron_list':
