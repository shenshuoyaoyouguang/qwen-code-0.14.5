...
export const addCommand: CommandModule = {
  ...
  builder: (yargs) =>
    yargs
      ...
      .positional('name', {
        describe: t('Name of the server'),
        type: 'string',
        demandOption: true,
      })
      .positional('commandOrUrl', {
        describe: t('Command (stdio) or URL (sse, http)'),
        type: 'string',
        demandOption: true,
      })
      .option('scope', {
        alias: 's',
        describe: t('Configuration scope (user or project)'),
        type: 'string',
        default: 'user',
      ...
      .option('env', {
        alias: 'e',
        describe: t('Set environment variables (e.g. -e KEY=value)'),
        type: 'array',
        string: true,
        nargs: 1,
      })
      ...
      .option('timeout', {
        describe: t('Set connection timeout in milliseconds'),
        type: 'number',
      })
      .option('trust', {
        describe: t(
      ...
      .option('description', {
        describe: t('Set the description for the server'),
        type: 'string',
      })
      .option('include-tools', {
        describe: t('A comma-separated list of tools to include'),
        type: 'array',
        string: true,
      })
      .option('exclude-tools', {
        describe: t('A comma-separated list of tools to exclude'),
        type: 'array',
        string: true,
      })
      .middleware((argv) => {
